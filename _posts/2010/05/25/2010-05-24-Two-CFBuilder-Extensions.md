...
You can download this extension via the download link below. The second extension I think might have greater appeal. The <a href="http://zipemailextension.riaforge.org/">Zip/Email</a> Extension does... well just that. Zipping and Emailing. If you ever needed to share code with someone quickly, this gives you right click support to do that. You can right click on a folder, a file, or select text in the editor itself, and the code will be sent to a zip file and then optionally emailed to a user. You can download that extension at the RIAForge URL linked above.<p><a href='enclosures/C{% raw %}%3A%{% endraw %}5Chosts{% raw %}%5C2009%{% endraw %}2Ecoldfusionjedi{% raw %}%2Ecom%{% endraw %}5Cenclosures{% raw %}%2Fmirror%{% endraw %}2Ezip'>Download attached file.</a></p>
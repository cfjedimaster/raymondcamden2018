...
<p/>
For download links, see <a href="http://www.meetup.com/coldfusionmeetup/pages/Recordings{% raw %}%20of%{% endraw %}20the{% raw %}%20ColdFusion%{% endraw %}20Meetup-2010">Charlie's master list</a> of recordings. The slide deck and code examples are available below. 
<p/>

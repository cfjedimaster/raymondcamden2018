...
The <a href="http://blogcfc.riaforge.org/index.cfm?event=page.svnview&path={% raw %}%2Finstall&file=readme%{% endraw %}2Etxt">readme.txt</a> file describes all the changes.

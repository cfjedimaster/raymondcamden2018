...
For folks who may not know what <a href="http://soundings.riaforge.org">Soundings</a> is - it is a simple ColdFusion based survey application. Like SurveyMonkey, just cooler because. Um. Because it's ColdFusion. There ya go.<p><a href='enclosures/C{% raw %}%3A%{% endraw %}5Chosts{% raw %}%5Cwww%{% endraw %}2Ecoldfusionjedi{% raw %}%2Ecom%{% endraw %}5Cenclosures{% raw %}%2Fsoundings%{% endraw %}2Ezip'>Download attached file.</a></p>
...
A big thank you to <a href="http://www.digitalprimates.com/">digital primates</a>. They needed the tool and paid me to development, then said they were cool with me giving it to the world.<p><a href='enclosures/D{% raw %}%3A%{% endraw %}5Chosts{% raw %}%5Cwww%{% endraw %}2Ecoldfusionjedi{% raw %}%2Ecom%{% endraw %}5Cenclosures{% raw %}%2FArchive13%{% endraw %}2Ezip'>Download attached file.</a></p>
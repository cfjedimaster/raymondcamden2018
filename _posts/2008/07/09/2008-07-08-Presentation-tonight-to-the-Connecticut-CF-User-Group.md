...
<b>Edit:</b> You can now download the PDF+code.<p><a href='enclosures/D{% raw %}%3A%{% endraw %}5Chosts{% raw %}%5Cwww%{% endraw %}2Ecoldfusionjedi{% raw %}%2Ecom%{% endraw %}5Cenclosures{% raw %}%2Fcfun08%{% endraw %}5Fajaxcf%2Ezip'>Download attached file.</a></p>
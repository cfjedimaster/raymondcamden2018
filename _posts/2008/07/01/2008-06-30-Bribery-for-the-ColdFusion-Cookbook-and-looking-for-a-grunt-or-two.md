...
Lastly - the site uses an XML file to search for and recognize CFML functions and tags within entries. It then automatically links to the documentation for each one it finds. I need someone willing to do the grunt work to add CF8 tags and functions, and to update every single link to the CF8 docs. (Right now they point to the CF7 docs.) This will be slow, boring work, but I'll give you credit, which along with 2.99 will get you a nice cup of coffee. Any takers?<p><a href='enclosures/D{% raw %}%3A%{% endraw %}5Chosts{% raw %}%5Cwww%{% endraw %}2Ecoldfusionjedi{% raw %}%2Ecom%{% endraw %}5Cenclosures{% raw %}%2Fcfml%{% endraw %}2Exml'>Download attached file.</a></p>